  ...
  return (
    <button
      ...
      className={`w-full rounded-3xl border px-4 py-4 text-left transition duration-200 ${
        active
          ? "border-cyan-300/40 bg-cyan-500/15 text-white shadow-[0_20px_60px_-45px_rgba(14,165,233,0.65)]"
          : "border-white/10 bg-white/5 text-white/70 hover:border-cyan-300/30 hover:bg-white/10"
      }`}
    >
