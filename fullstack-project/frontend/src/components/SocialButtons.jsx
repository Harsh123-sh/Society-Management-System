export default function SocialButtons() {
  return (
    <div className="grid grid-cols-3 gap-3">
      <button className="flex items-center justify-center gap-2 rounded-2xl border border-[rgba(255,255,255,0.12)] bg-[rgba(255,255,255,0.08)] px-3 py-3 text-sm text-[var(--text-main)] shadow-lg shadow-[rgba(15,23,42,0.18)] transition hover:bg-[rgba(255,255,255,0.12)]">
